...
class AdminDevTools
    ...
    constructor(
        ...
        suspend fun clearLocalRequests(): String =
        ...
        suspend fun clearAllRequests(): String =
            withContext(Dispatchers.IO) {
                val activation = activeActivation()
        ...
        suspend fun clearExtraTimeGrants(): String =
            withContext(Dispatchers.IO) {
                val activation = activeActivation()
