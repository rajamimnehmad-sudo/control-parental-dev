...
internal class ChromeOriginalUiSvgFixture {
    ...
    fun responseFor(request: ChromePhotosProxyRequest): ChromePhotosFixtureResponse? {
        ...
        return when (path) {
            ...
            NetworkSvgPath -> response("ui-svg-network", SvgMimeType, StyledNetworkSvg)
    ...
    private companion object {
        ...
        val StyledNetworkSvg =
            """<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" width="24" height="24"><defs><style>.paint {fill:#146c43;stroke:#123456;stroke-width:.28px;}</style></defs><path class="paint" d="M2 3h20v18H2z"/></svg>""".toByteArray()
        val UnsafeSvg =
