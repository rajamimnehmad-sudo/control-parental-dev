...
- Seguimiento DEV 276 validado en SM-A235M: los modelos visuales se preparan mientras WebView descarga HTML y las fotos permitidas ya no generan miniaturas JPEG de calibracion sin uso. La referencia Samsung paso de aproximadamente 9,5 s en DEV 275 a 5,9 s en el primer recorrido y 4,0 s en la repeticion, con PSS aproximada 555-561 MB, heap nativo 342-348 MB y 26,2 C. No cambian decisiones, umbrales ni la espera cerrada de cada imagen. El modelo TFLite compacto fue 3,5 veces mas rapido y coincidio en 19/19 fotos seguras, pero no reemplaza al profesional por faltar un corpus etiquetado representativo de bloqueos. La cache entre paginas por hash y NNAPI adaptativo siguen sin habilitarse sin invalidacion y benchmarks seguros.
