...
## Candidato local - Epic UX Admin, banner y horarios - 2026-07-19
...
- Alineación posterior de App Usuario: Avisos, Ajustes, Solicitudes y Enlace usan la misma línea de estado. Enlace prioriza el aviso de desvinculación sobre el estado ordinario y nunca agrupa dos estados; Solicitudes mantiene el estado visible al desplazar. Home adopta el mismo encabezado oscuro de Admin, a todo el ancho y con sólo las esquinas inferiores redondeadas, sin la tarjeta ilustrada gigante anterior. Mis apps conserva una lista nativa eficiente, fuerza todas las filas al ancho disponible y organiza sus cuatro filtros en una grilla 2 x 2 para evitar recortes. Validación dirigida: ktlint, tests disponibles y `assembleDevDebug` de Usuario correctos; no hubo publicación.
...
## Candidato local - Politica DAG por audiencia - 2026-07-19
...
- Estado: cambios locales sin `versionCode`, commit, push ni publicacion. DEV publico permanece en 260 hasta autorizacion explicita del usuario.
