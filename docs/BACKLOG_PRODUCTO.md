...
- Estado: `Piloto de ampliacion NO-GO; pendiente consistencia explicita`. El 2026-08-09 se midieron 28 originales y 84 variantes: R3.1 pasó de detectar 6/7 peligrosas originales a solo 2/7 circulares, con 8 degradaciones `filter` a `allow` entre pares. Dos pilotos de ampliacion redujeron apenas los falsos permisos globales de 12/28 a 11/28, pero elevaron falsos filtros de 5/84 a 7/84 y 10/84, sin corregir ninguna circular peligrosa. El siguiente intento debe usar perdida de consistencia original-variante con gates congelados; no seguir ajustando pesos al azar. Evidencia: `docs/dag/v3/GLOSHIA_R4_THUMBNAIL_REPAIR_PILOT_2026-08-09.md`. Este ticket debe revisarse obligatoriamente cuando el usuario pida entrenar, reentrenar o reemplazar GloshIA Visual. No autoriza por si mismo cambiar R3, el modelo integrado, los umbrales ni la politica visual vigente.
