...
- Estado: `Pendiente para el proximo entrenamiento autorizado de GloshIA Visual`. Este ticket debe revisarse obligatoriamente cuando el usuario pida entrenar, reentrenar o reemplazar GloshIA Visual. No autoriza por si mismo cambiar R3, el modelo integrado, los umbrales ni la politica visual vigente.
