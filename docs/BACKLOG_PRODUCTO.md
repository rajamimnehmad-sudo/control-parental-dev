...
| --- | --- | --- | --- | --- | --- |
| SEC-LICENSE-01 | En progreso; tramo A implementado en DEV | P0 | Ciclo de vida de comunidad y licencia: alta, renovacion, vencimiento y restauracion sin perder configuracion | L | Alto |
