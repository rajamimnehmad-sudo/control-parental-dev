...
- Estado: `Compuerta completa validada en DAG 199; atajos de runtime cerrados; decisión de producto pendiente`. El 2026-08-11 un A/B sobre 536 decisiones eligió señal completa global `>= 0,95`: corrigió 13 permisos erróneos sin agregar falsos filtros y el propietario confirmó el caso físico. Las miniaturas circulares sí se analizan, pero R3.1 pierde señal. R1 como segundo veto redujo 85 falsos permisos a 56 y disparó falsos filtros de 28 a 85. Un MobileNetV4 especializado bajó permisos a 22, pero disparó falsos filtros a 256 y produjo 54/76 falsos filtros en el holdout compacto. Ambos son `NO-GO`, sin checkpoints, ONNX o APK. Diagnostic 4 comprobó físicamente que Google no declara `srcset`, candidatos mayores ni `picture` en los raster relevantes; 12 miniaturas de 56-82 px cruzaron GloshIA, cuatro se bloquearon y ocho se permitieron con puntajes de 0,0283 a 0,8419. No hay bypass ni fuente estándar mayor que rescatar. El laboratorio descarta ahora recursos inline y placeholders internos para no contaminar los logs. No repetir pesos, umbrales, representaciones o backbones con estos gates. Próxima decisión: corpus compacto independiente o política explícita de cierre por incertidumbre aceptando falsos filtros. R3.1 sigue oficial. Evidencia: `docs/dag/v3/GLOSHIA_R31_RUNTIME_GATE_2026-08-11.md`, `docs/dag/v3/GLOSHIA_R4_THUMBNAIL_REPAIR_PILOT_2026-08-09.md` y `docs/compatibility/results/dag-browser-v201-compact-source-diagnostic-sm-s908e-2026-08-11.md`.
