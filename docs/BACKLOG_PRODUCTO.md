...
| --- | --- | --- | --- | --- | --- |
| PROTECTION-POSSIBLE-UNINSTALL-01 | Implementado candidato DEV 266; pendiente prueba fisica y publicacion | P0 | Alerta maxima persistente y pasos de restablecimiento ante posible desinstalacion | M | Alto |
| PROTECTION-OFFLINE-RECOVERY-02 | Implementado candidato DEV 266; pendiente prueba fisica y publicacion | P0 | Cinco codigos de recuperacion de un solo uso preparados para operar sin Internet | L | Alto |
| HELP-CONTEXTUAL-CHAT-01 | Implementado candidato DEV 266; pendiente prueba fisica y publicacion | P1 | Chat privado de ayuda, acotado a la app y contextual a todos los dispositivos | M | Medio |
| ADMIN-USER-SECTIONS-UX-04 | Implementado candidato DEV 266; pendiente prueba fisica y publicacion | P1 | Separar Aplicaciones, Web y Seguridad con selector horizontal moderno | M | Medio |
