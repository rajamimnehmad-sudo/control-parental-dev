...
- Corpus dirigido revisado: los 120 grupos nuevos terminaron en 59 allow y 61 filter, sin dudas ni duplicados. R3.1 obtuvo 15 falsos permisos y 43 falsos filtros. Estado: `revisión completa, entrenamiento no autorizado`; no fusionar para train, entrenar, exportar ni integrar hasta una autorización explícita del propietario.
