...
- Estado: `Compuerta de señal completa validada físicamente en DAG 199; miniaturas variables siguen NO-GO`. El 2026-08-11 un A/B sobre 536 decisiones del propietario eligió señal completa global `>= 0,95`: corrigió 13 permisos erróneos sin agregar falsos filtros en ese examen. El propietario confirmó en DAG normal que el caso físico corregido ya no aparece. Diagnostic reprodujo una miniatura de bikini `137x137` en `0,9453`; una compuerta compacta experimental `0,94` se retiró porque otra variante física `62x82` bajó a `0,7847-0,9166` y continuó visible. Regiones forzadas y cinco representaciones también fallaron el gate; endurecer por tamaño o hasta esa banda bloquearía contenido permitido. La captura y los logs demostraron que las miniaturas circulares sí se analizan y R3.1 las permite con señal baja. El siguiente paso autorizado es un modelo compacto candidato mejor entrenado con pares original/miniatura y negativos cercanos; R3.1 sigue oficial hasta pasar todos los gates. Evidencia nueva: `docs/dag/v3/GLOSHIA_R31_RUNTIME_GATE_2026-08-11.md`. Evidencia de entrenamiento: `docs/dag/v3/GLOSHIA_R4_THUMBNAIL_REPAIR_PILOT_2026-08-09.md`. Este ticket debe revisarse obligatoriamente cuando el usuario pida entrenar, reentrenar o reemplazar GloshIA Visual.
