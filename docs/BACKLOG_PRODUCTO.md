...
- Estado conjunto: `DEV 255 en cierre`; aprobado explicitamente por el usuario el 2026-07-17 para ejecutar los tickets seguidos y publicar una sola vez al final. Solo queda completar la publicacion y el recorrido visual autenticado de la cola Super Admin.
...
- Cierre DEV 255 en curso: matriz local de 903 tareas Android y controles Web correctos; ambos `versionCode` en 255; Edge v6 y las dos migraciones nuevas activas solo en DEV, sin archivar ni borrar las 106 revisiones existentes. Pendiente la publicacion unica de APK, el despliegue Vercel del commit y el recorrido autenticado de `Borrar todas` y Calibracion DAG.
