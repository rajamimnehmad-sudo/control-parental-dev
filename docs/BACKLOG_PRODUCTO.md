...
| DAG-IMAGE-FILTER-1 | Idea autorizada para backlog; no aprobada para codigo | P1 | Prefiltro local liviano que libera solo imagenes confirmadas sin presencia ni rasgos humanos y deriva el resto al analisis completo | M | Alto |
...
- Nombre de producto: `Filtro 1`. Estado: `Idea autorizada para backlog; no aprobada para codigo`. Tipo: rendimiento y seguridad visual. Prioridad: P1. Esfuerzo: M. Riesgo: alto.
