...
`DAG-STRUCTURE-01` completo siete cortes neutrales: diagnostico, identidad de
...
salieron a modulos acotados. `video-lab.js` bajo de 1.758 a 1.357 lineas sin mover la autoridad ni
...
- `video-lab.js` aun tiene 1.357 lineas. `DAG-STRUCTURE-01` esta en progreso;
  el siguiente corte debe separar revocacion y captura fluida antes
